  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li><strong>Get a professional inspection.</strong> An experienced roofer can identify and document damage an untrained eye misses — and put it in terms an adjuster understands.</li>
        ...
        <li><strong>Make temporary repairs to prevent further damage.</strong> Tarping a leak, for example, is usually expected — keep the receipts.</li>
      ...
      <p>
        <em>
          This article is general information, not insurance advice. Your coverage depends on your specific policy —
