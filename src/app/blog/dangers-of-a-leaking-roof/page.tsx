...
export default function Page() {
  return (
    ...
    >
      ...
      <p>
        A leak doesn’t keep business hours, so neither do we. If water is getting into your home, call us any time. We’ll
        respond fast, stop the leak, and make the lasting repair, then document everything for your insurance.
      </p>
    </BlogPost>
  );
}
